 ...
 * @author Hugo
 */
public class BSTB <E extends Comparable<E>> implements BSTInterface<E> {
    ...
    * @return true if the tree is empty, false otherwise
    ...
    class Compare implements Comparator<E> {
        ...
        public int compare(E t, E t1) {
            Pair a = (Pair) t;
            Pair b = (Pair) t1;
            if (a.getNumFronteiras()-b.getNumFronteiras()==0){
                return (int) (a.getCountry().getPopulacao()-b.getCountry().getPopulacao());
            } else{
                return b.getNumFronteiras()-a.getNumFronteiras();
            }
        }
        }
    /*
